...
describe("PI Adapter (Phase 1)", () => {
  ...
  it("should parse basic PI structure", async () => {
    ...
    const ir = await piAdapter.parse(tmpDir);
  ...
  it("should render blueprint to PI format with pi.config.ts", async () => {
    const piAdapter = new PIAdapter();
    ...
    const writtenFiles = await piAdapter.render(ir, tmpDir);
  ...
  it("should generate TypeScript config with agents", async () => {
    const piAdapter = new PIAdapter();
    ...
    await piAdapter.render(ir, tmpDir);
  ...
  it("should generate teams.yaml from orchestration", async () => {
    const piAdapter = new PIAdapter();
  ...
  it("should generate chains.yaml from orchestration", async () => {
    const piAdapter = new PIAdapter();
  ...
  it("should support round-trip conversion", async () => {
    ...
    const ir1 = await piAdapter.parse(tmpDir);

    const tmpDir2 = createTmpDir();
    try {
      await piAdapter.render(ir1, tmpDir2);
      const ir2 = await piAdapter.parse(tmpDir2);
  ...
  it("should handle model config in TypeScript", async () => {
    const piAdapter = new PIAdapter();
